  ...
  return (
    ...
    >
      <div className="flex flex-col h-screen w-full bg-background font-accent overflow-hidden">
        {/* Independent Topbar */}
        <header className="flex h-14 w-full shrink-0 items-center justify-between border-b border-border bg-background/80 backdrop-blur-md z-50 fixed top-0 left-0 pr-4">
